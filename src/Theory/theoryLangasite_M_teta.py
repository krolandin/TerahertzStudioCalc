...
class TheoryLangasite_M_teta(Theory):
    name = "Ho LGS M(teta)"
...
@guvectorize([
    "void(float32[:], float32, float32, float32, float32, float32, float32, float32, float32, float32, float32, float32, float32, float32, float32, float32, float32[:], float32[:], float32[:])"],
    "(n),(),(),(),(),(),(),(),(),(),(),(),(),(),(),()->(n),(n),(n)",
    target='parallel')
