...
class TheoryLangasite_RandomDist(Theory):
    name = "Theory Ho langasite RandomDist"
        ...
        for j in range(self.numPoints):
            ...
            for i in range(6):
                ...
                for iDcf in range(0, self.oneSidePointsNum):
                    ...
                    f0 = DPos
                    dMu = self.getDMu(DPos, vectM, Dcf) * self.randomDistortions(Dcf/self.Dcf)
    ...
    def calcConstants(self):
        ...
        self.dDcf = 20 * self.Dcf / self.oneSidePointsNum
    ...
    def randomDistortions(self, x):
        return math.sqrt(2) * x * math.pow(x**2 + 2, -1.5)
